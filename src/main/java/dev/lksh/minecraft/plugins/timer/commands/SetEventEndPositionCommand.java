...
public class SetEventEndPositionCommand implements CommandExecutor {
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
    ...
    plugin.getDatabase().setEndPosition(eventId, posX, posY, posZ, margin);

    sender.sendMessage("Set end position to " + posX + " " + posY + " " + posZ + ", margin = " + margin);
    return true;
  }

  public SetEventEndPositionCommand(IndigestionTimer plugin) {
    this.plugin = plugin;
  }
}
